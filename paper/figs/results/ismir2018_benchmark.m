...
legends = {'a', 'b', 'MFCC', 'MFCC + LMNN', 'scattering', 'scattering + LMNN'};
...
plot(log10(time_scales), mfcc_lmnn_inst, '-', ...
    'LineWidth', 1.5, 'Color', mfcc_color, ...
    'MarkerSize', 6);
plot(log10(time_scales(1)), mfcc_none_inst(1), '--o', ...
    'LineWidth', 1.5, 'Color', mfcc_color, ...
    'MarkerFaceColor', mfcc_color, 'MarkerSize', 6);
plot(log10(time_scales(1)), mfcc_lmnn_inst(1), '-o', ...
    'LineWidth', 1.5, 'Color', mfcc_color, ...
    'MarkerFaceColor', mfcc_color, 'MarkerSize', 6);
plot(log10(time_scales), scat_none_inst, '--d', ...
    'LineWidth', 1.5, 'Color', scat_color, ...
    'MarkerFaceColor', scat_color, 'MarkerSize', 6);
plot(log10(time_scales), scat_lmnn_inst, '-d', ...
    'LineWidth', 1.5, 'Color', scat_color, ...
    'MarkerFaceColor', scat_color, 'MarkerSize', 6);
