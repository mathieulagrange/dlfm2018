...
Therefore, the knowledge of organology (the \emph{what?} of instrumental music), as opposed to agogics (the \emph{how?}), is a rather weak source of information for browsing and recommending music in large online databases.

Yet, current research in music information retrieval (MIR) too rarely accounts for the 
