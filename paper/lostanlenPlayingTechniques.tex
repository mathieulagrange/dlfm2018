...
\subsection{Representation} % Scattering transform
\cite{anden2012dafx}

\section{Supservised projection} % Large-margin nearest neighbors
...
One standard approach is the use of the linear discriminant analysis (LDA) that projects the objects...
