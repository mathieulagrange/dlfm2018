...
On the other hand, the few publications which frame timbral similarity in a polyphonic setting do so according to a purely perceptual definition of timbre -- with continuous attributes such as brightness, warmth, dullness, roughness, and so forth \cite{antoine2018isma} --
We refer to \cite{leman2017chapter} for a recent review of the state of the art.
% cite antoine 2018 isma
