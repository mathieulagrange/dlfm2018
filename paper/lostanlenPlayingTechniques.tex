...
On the other hand, the LMNN 

Considering the LMNN algorithm to project the features only marginally improves the performance for the MFCC baseline (p@5 of $90\%$), whereas the scattering features highly benefit from it.
...
Therefore, it is the multiresolution structure of scattering coefficients, rather than its dimensionality, which allows a strong boost in performance.
