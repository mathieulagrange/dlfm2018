...
Although one of its major drawback relies on its strong dependency on the Euclidean neighbors to learn $\mathbf{L}$ \cite{mcfee2010icml}
The linearity of LMNN provides some robustness to 
