...
This issue is partially mitigated by multitrack datasets, such as MedleyDB \cite{bittner2014ismir}, which have renewed the interest in monophonic instrumental recordings \cite{yip2017ismir}.
We refer to \cite{han2017taslp} for a recent review of the state of the art.
\cite{lostanlen2018msdb}
