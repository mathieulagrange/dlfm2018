...
In addition, the cross-collection evaluation procedure \cite{livshin2003ismir} allows to prevent the risk of overfitting caused by the relative homogeneity of these small datasets in terms of artists and recording conditions \cite{bogdanov2016ismir}.
Following \cite{donnelly2015ismir}, the recently released Medley-solos-DB dataset contains constant-duration excerpts of both MedleyDB and solosDb \cite{lostanlen2018msdb}
train state-of-the-art models, 

We refer to \cite{han2017taslp} for a recent review of the state of the art.
% \cite{livshin2003ismir} \cite{donnelly2015icdmw} \cite{bogdanov2016ismir} \cite{lostanlen2018msdb}
...
Cross-cultural Comparisons of Expressivity in Recorded Erhu and Violin Music: Performer Vibrato Styles: \cite{yang2014fma}.
