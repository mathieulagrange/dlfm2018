...
The Open-MIC initiative, from the newly created Community for Open and Sustainable Music and Information Research (COSMIR), might soon contribute to resolving them in the future \cite{mcfee2016ismir}.
...
Nevertheless, the vast majority of the available literature on this topic focuses on the range of playing techniques afforded by a single instrument: recent examples include clarinet \cite{loureiro2004ismir}, percussion \cite{tindale2004ismir}, piano \cite{bernays2013smc}, guitar \cite{foulon2013cmmr,su2014ismir,chen2015ismir}, violin \cite{young2008nime}, cello \cite[chapter 6]{chudy2016phd}, and erhu \cite{yang2014fma}.


% to the best of our knowledge, all 
%This paper aims at addressing this gap.
