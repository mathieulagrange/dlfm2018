...
the addition of new instruments to the Western symphonic instrumentarium, either by technological inventions (e.g. theremin) or importation from non-Western musical cultures (e.g. marimba) \cite{sachs2012book};
...
a more systematic usage of extended instrumental techniques, such as snap pizzicato, col legno batutto, or flutter tonguing \cite{kostka2016book};
...
% composition with gesture and sound. Emerging notion of gesture. The so-called ``ordinary'' playing technique is only one among many others. Whereas in the Romantic period there were playing techniques but they were figurative.
% A growing concern on the concept of gesture has liberated 
In particular, an increased concern for the concept of musical gesture \cite{godoy2009book} liberated many unconventional instrumental techniques from their figuralist cradle 
