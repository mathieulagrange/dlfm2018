...
: a violin note from the SOL dataset, played with ordinary playing technique, pitch G4, \emph{mf} dynamics, on the G string.


Figure \ref{fig:demo} shows the constant-$Q$ scalograms of the five retrieved items 
