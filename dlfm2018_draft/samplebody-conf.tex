...
However, although the scattering-based version is also $100\%$ correct in terms of IPT retrieval (as it retrieves five \emph{ordinario} notes), the MFCC-based version is only $40\%$ correct: three of the retrieved items exhibit other playing techniques, namely \emph{tremolo} and \emph{sul ponticello} (bowing on the bridge of the violin).
