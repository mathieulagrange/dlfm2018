...
\begin{figure}
        ...
        \begin{subfigure}{0.20\textwidth}
                \centering
                \includegraphics[width=\linewidth]{./figs/demo/Vn-ord-G4-mf-4c.png}
                \caption{.}
                \label{fig:Vn-ord-G4-mf-4c}
        \end{subfigure}%
        \begin{subfigure}{0.20\textwidth}
...
\begin{figure}       
        \begin{subfigure}{0.20\textwidth}
                \centering
                \includegraphics[width=\linewidth]{./figs/demo/TpC-flatt-G4-mf.png}
                \caption{.}
