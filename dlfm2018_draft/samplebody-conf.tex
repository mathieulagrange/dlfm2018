...
\begin{figure}
        ...
        \begin{subfigure}{0.20\textwidth}
                ...
                \caption{5: \emph{tremolo}, C\#5, \emph{pp}.}
...
\begin{figure*}       
        ...
        \end{subfigure}%
        \caption{Low-dimensional embeddings of MFCC features (left) \vs{} scattering transform features (right). Each dot corresponds to a different musical note in the SOL dataset, restricted to the \emph{ordinario} playing technique of each of the $31$ different instrument-mute couples. Blue (\resp{} orange) dots denote violin (\resp{} trumpet in C) notes, including notes played with a mute: \emph{sordina} and \emph{sordina piombo} (\resp{} \emph{cup}, \emph{harmon}, \emph{straight}, and \emph{wah}).
        \label{fig:instrument-embeddings}
\end{figure*}
...
\begin{figure*}
        ...
        \caption{Low-dimensional embeddings of MFCC features (left) \vs{} scattering transform features (right). Each dot corresponds to a different musical note in the SOL dataset, restricted to $11$ instrument-mute couples associated to the $4$ instruments in the violin family: violin, viola, violoncello, and contrabass. The number of instrumental playing techniques in this subset of SOL is equal to $38$. Blue (\resp{} orange) dots denote tremolo (\resp{} ordinary) notes.}
        \label{fig:technique-embeddings}
\end{figure*}
