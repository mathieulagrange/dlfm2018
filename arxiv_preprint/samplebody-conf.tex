...
\begin{figure}
        ...
        \begin{subfigure}{0.25\textwidth}
                \centering
                \scal{TpC-ord-G3-mf.png}
                \caption{Pitch (G3).}
                \label{fig:TpC-ord-G3-mf_withaxes}
        \end{subfigure}%
        \begin{subfigure}{0.25\textwidth}
                \centering
                \scal{TpC-ord-G4-pp.png}
...
\begin{figure}[t!]
\centering
\includegraphics[width=\linewidth]{instrument-dendrogram.eps}
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{technique-dendrogram.eps}
...
\node[anchor=north west] at (2, 0) {\includegraphics[height=149mm]{histogram_modes.pdf}};
\foreach \x in {0,...,49}
...
\begin{figure}
        ...
        \begin{subfigure}{0.20\textwidth}
                \centering
                \scal{Vn-ord-Gsh4-mf-4c.png}
                \caption*{4: G\#4.}
                \label{fig:Vn-ord-Gsh4-mf-4c}
        \end{subfigure}%
        \begin{subfigure}{0.20\textwidth}
                \centering
                \scal{Vn-ord-G4-ff-3c.png}
...
\begin{figure}
        ...
        \begin{subfigure}{0.20\textwidth}
                \centering
                \scal{TpC-flatt-Fsh4-mf.png}
                \caption*{1: F$\sharp$4.}
                \label{fig:TpC-flatt-Fsh4-mf-left}
        \end{subfigure}%
        \begin{subfigure}{0.20\textwidth}
                \centering
                \scal{TpC-flatt-G4-pp.png}
                \caption*{1: \emph{pp}.}
